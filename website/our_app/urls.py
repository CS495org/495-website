...
urlpatterns = [
    ...
    path('update-fav-movies/', views.RedirectByID.as_view(), name='update_movies_redirect'),
    path('update-fav-shows/<slug:pk>/', views.UpdateFavShowsView.as_view(), name='update_fav_shows'),
    path('update-fav-shows/', views.RedirectByID.as_view(), name='update_shows_redirect'),
