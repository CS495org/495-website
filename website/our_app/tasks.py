...
from accounts.models import Movie, Show, CustomUser, TopRatedShow
import requests
...
def get_images():
    try:
        ...
        + [tr.poster_path for tr in TopRatedShow.objects.all()]\
        + [tr.backdrop_path for tr in TopRatedShow.objects.all()] 
